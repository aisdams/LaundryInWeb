    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table table-hover table-striped border rounded-1" id="karyawan">
            <thead>
              <tr>
            ...
            <tbody>
              ...
              @foreach ($karyawan as $idx)
                <tr>
                  ...
                  {{-- Button Action --}}
                  <a class="dropdown-item mb-1" href="{{ url('data-karyawan/'.$idx->id.'/edit')}}" ><i class="fa-solid fa-pen-to-square text-success mr-2"></i>Edit</a>
