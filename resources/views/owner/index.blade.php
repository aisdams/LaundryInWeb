    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table table-hover table-striped border rounded-1" id="owner">
            <thead>
              <tr>
            ...
            <tbody>
              ...
              @foreach ($data as $idx)
                <tr>
                  ...
                  {{-- Button Action --}}
                  <a class="dropdown-item mb-1" href="{{ url('data-owner/'.$idx->id.'/edit')}}" ><i class="fa-solid fa-pen-to-square text-success mr-2"></i>Edit</a>
