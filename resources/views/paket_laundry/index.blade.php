    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex justify-content-between">
          <h2>Tabel Data Paket Laundry</h2>
          <a href="{{url ('paket-laundry/create')}}" class="tbl-btn button btn-primary p-2 rounded-2">Add New Paket</a>
        </div>
          ...
          <table class="table table-hover table-striped border rounded-1">
            <thead>
              <tr>
                ...
                <th class="fw-bold text-center">Nama Paket</th>
