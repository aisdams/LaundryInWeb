...
<div class="col-md-12 grid-margin stretch-card">
  <div class="card">
    <div class="card-body d-flex flex-column gap-4">
      ...
      <form class="forms-sample mt-3" action="{{ url('data-karyawan')}}" method="POST">
        @csrf
        ...
        <div class="form-group">
          ...
          <div class="input-group-append">
            ...
            <span class="input-group-text"  style="background-color: blueviolet" onclick="password_show_hide();">
              <i class="fas fa-eye text-white" id="show_eye"></i>
              <i class="fas fa-eye-slash d-none text-white" id="hide_eye"></i>
            </span>
          </div>
